...
# Whenever we enter 'welcome' or 'congrats', regenerate for the current level
...
# --- Question Page ---
    ...
    # Progress bar: show fraction of answered questions
    progress_ratio = q_idx / 5  # 0.0–1.0
    ...
    if q_idx < len(questions_this_level):
        ...
        # All 5 questions answered → go to congrats
...
# --- Summary Page ---
    ...
    st.markdown(f"<h2 style='color:#0055ff;'>You got {total_correct} out of {total_questions} questions right!</h2>", unsafe_allow_html=True)
